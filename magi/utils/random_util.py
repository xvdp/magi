...
from .. import config
# from .random_util import torch_dtype #torch_dtype(None, force_default=True)
...
# def get_random(tensor, a, b, p, distribution, independent):
...
#     prob = bernoulli(p, size, dtype, device)

#     if distribution == 'normal':
#         _mean = (a + b)/2
#         a = math.fabs(_mean - a)
#         out = normal(_mean, a/3, size, dtype, device)
#     else:
#         out = uniform(a, b, size, dtype, device)
